...
class OngEditProfilePageController extends GetxController {
...
class OngEditBioProfilePage extends StatelessWidget {
  ...
  final ongEditProfilePageController = Get.put(OngEditProfilePageController());
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: GetBuilder<OngEditProfilePageController>(
        init: OngEditProfilePageController(),
        builder: (_) {
          return  Scaffold(
           body:Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () async{
                          ...
                          ongEditProfilePageController.concluirEdicao();
                          Get.back();
                ...
                padding: const EdgeInsets.all(16.0),
                  child: TextField(
                    controller: ongEditProfilePageController.bioText,
